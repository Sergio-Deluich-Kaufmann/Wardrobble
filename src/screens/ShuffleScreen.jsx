...
import { ShuffleIcon, HeartIcon, LockIcon, UnlockIcon, ClothingPlaceholder } from '../icons';
      ...
      <div style={{ padding: '10px 12px 13px' }}>
        ...
        {item && (
          <div style={{ display: 'flex', alignItems: 'center', gap: 5, marginTop: 5 }}>
            <div style={{ width: 8, height: 8, borderRadius: '50%', background: COLOR_HEX[item.color] || '#ccc', boxShadow: '0 0 0 1.5px rgba(220,192,191,0.4)' }}/>
...
const ShuffleScreen = ({ items, onSaveOutfit, savedCount }) => {
  ...
  const handleSave = () => {
    ...
    onSaveOutfit({ name: `Look #${savedCount + 1}`, date, items: outfitItems });
    setSaved(true);
